<template>
  ...
  <div class="parallax_layer bot_layer"></div>
  <div class="parallax_layer mid_layer q-gutter-xl">
    <q-space />
    <div class="text-h1 text-white">Who is MK</div>
    <q-space />
    <q-space />
    <q-space />
  </div>
  <div class="parallax_layer top_layer">
    ...
    <div
      style="
        ...
        width: 175px;
        height: 20px;
        transform: translateX(320px) translateY(-275px);
    ...
    <div
      style="
        ...
        width: 250px;
        height: 20px;
        transform: translateX(320px) translateY(-245px);
        border-radius: 50px 50px 0px 0px;
        opacity: 0.7;
      "
    ></div>
    <div
      style="
        ...
        width: 300px;
        height: 20px;
        transform: translateX(320px) translateY(263px);
  ...
  <div class="parallax_layer final_layer"></div>
</template>
